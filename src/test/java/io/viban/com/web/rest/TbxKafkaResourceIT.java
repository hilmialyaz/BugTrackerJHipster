...
public class TbxKafkaResourceIT {
    ...
    @Autowired
    private TbxKafkaProducer producer;

    @Autowired
    private TbxKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        TbxKafkaResource kafkaResource = new TbxKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/tbx-kafka/publish?message=test"))
